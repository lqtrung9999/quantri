(() => {
  ...
  function filtered() {
    ...
    return leads.filter(lead => {
      const quick = activeTab === 'all' || (activeTab.startsWith('status:') ? lead.status === activeTab.slice(7) : lead.category === activeTab.slice(9));
