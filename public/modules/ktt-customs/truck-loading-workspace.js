(() => {
  ...
  discussionStyle.textContent = `#cf-truck-workspace .tl-discussion{border:1px solid #cfdae8;border-radius:7px;background:#fff;color:#426b9f;padding:6px 8px;font:inherit;font-weight:800;cursor:pointer;white-space:nowrap}`;
