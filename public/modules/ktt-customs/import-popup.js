(() => {
  ...
  opener.onclick = () => { get('#cf-import-note').textContent = 'Các mã vừa lưu sẽ xuất hiện ngay trong danh sách công việc chung.'; modal.classList.add('open'); get('#cf-import-paste').focus(); };
  renderPreview();
})();
